...
{
    public class AssociateProgrammer : Employee, ICompany
    {
        #region Constructors
        public AssociateProgrammer() : this(0, "Unknown", "Unknown", 0, DateTime.MinValue, DateTime.MinValue, 0)
        {
        }

        public AssociateProgrammer(int empID, String firstName, String lastName, int jobCode, DateTime _DOB, DateTime _hireDate, decimal _currentSalary) :
        ...
        {
            if (CompletedTasks > 3) { return CurrentSalary * (decimal)0.03; }
            if (CompletedTasks > 2) { return CurrentSalary * (decimal)0.02; }
            if (CompletedTasks > 1) { return CurrentSalary * (decimal)0.01; }
            return 0;
        }
        ...
        public static string ReportHeader()
        {
            ...
            return line + $"Associate Programmers" + "\n" + line +
